...
namespace ManagedPatcher.Patcher.Setup
{
    partial class MainForm
    {
        ...
        private void InitializeComponent() {
            ...
            this.toolTipButtons.SetToolTip(this.buttonSetup, "Complete environment setup for working on ManagedPatcher source\r\nEquivalent to Decomp" +
        "ile+Patch+SetupDebug\r\nEdit the source in src/ManagedPatcher then run Diff ManagedPatcher" +
        ...
        "t to Setup without Decompile");
            ...
            this.Name = "MainForm";
            this.Text = "ManagedPatcher.Patcher";
